...
<div style="display: flex; justify-content: space-between; align-items: center; width: 100%">
    <img style="width: 49%; height: auto; object-fit: contain" src="./assets/img/calc_smartphone.png">
    <img style="width: 49%; height: auto; object-fit: contain"  src="./assets/img/calc_tablet.png">
</div>
